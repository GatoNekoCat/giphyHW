const topics = ["energy", "universe", "spiritual", "virtual"];
let data;
let stillId;
let activeId;
...
function displayTopicInfo() {
  ...
  const queryURL = 'https://api.giphy.com/v1/gifs/search?q=' + topic + '&api_key=9jnsa8aEDjFHI625YBd5B2d0qz5hxWbX&limit=10&limit=10';
  ...
  $.ajax({
    ...
    data = response.data;
    let viewDiv = $("<div class = moveOrStill>");
